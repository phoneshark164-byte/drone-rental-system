...
class CropLayer extends BaseUtils {
    ...
    iconMap = {
        ...
        // 四川作物
        '水稻': { icon: 'xiangjiao.png', style: 10},
        '小麦': { icon: 'fanshiliu.png', style: 11},
        '油菜': { icon: 'huolongguo.png', style: 12},
        '玉米': { icon: 'hongshu.png', style: 13},
    }
    ...
    async init() {
        ...
        const style = Object.keys(this.iconMap).map(key=>{
            ...
            return {
                url: `/digital-twin-static/icons/${icon}`,
